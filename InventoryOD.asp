...
<body onUnload="javascript:window.opener.location='<%=C_HomePath%>order.asp'" >
...
<BR>
Sorry, we don't have your requested quantity in stock. A total of <%=ordQTY%> 
items have been added to your order. If you would like us to send you the remaining 
quantity as soon as available, click the Back Order button below.
<%
