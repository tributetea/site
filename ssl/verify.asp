...
%>
<title>TRIBUTE TEA CHECKOUT - 2. Payment Details</title>
  ...
  <tr>
    <td>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="3">
        ...
        <tr>
          <td align="center" class="tdMiddleTopBanner"><font face="Arial, Helvetica, sans-serif">Payment 
            Details</font></td>
        </tr>
        <tr>
          <td class="tdBottomTopBanner"> 
            <div align="center"><font face="Arial, Helvetica, sans-serif">Please 
              review your order and enter payment details below.<br>
              When finished click &quot;<b>checkout</b>&quot; to submit your transaction 
              for processing.</font> </div>
          
        </tr>
        <tr>
          <td width="100%" align="center" class="tdContent2"  valign="center"> 
            <p><img src="step2.gif" width="540" height="12"></p>
            </td>
        </tr>
        <tr>
          <td class="tdContent2" width="100%">        
            <table border="0" width="100%" cellspacing="0" cellpadding="4">
              <tr>
                <td width="52%" class="tdContentBar"><font face="Arial, Helvetica, sans-serif">product</font></td>
                <td width="16%" align="center" class="tdContentBar"><font face="Arial, Helvetica, sans-serif">unit 
                  price</font></td>
                <td width="16%" align="center" class="tdContentBar"><font face="Arial, Helvetica, sans-serif">qty</font></td>
                <td width="16%" align="center" class="tdContentBar"><font face="Arial, Helvetica, sans-serif">price</font></td>
                </tr>
              <%
'@BEGINCODE
...
%>
          ...
          <tr>
          <td class="tdContent2" height="192"> 
            <table border="0" width="100%" cellspacing="0" cellpadding="2" class="tdContent2" height="185">
              <%OVC_ShowOrderDiscounts 'SFAE%>
              <tr> 
                <td width="575" align="right" height="22"><b><font face="Arial, Helvetica, sans-serif">Sub 
                  Total:</font></b></td>
		...
		%>
              ...
              <tr> 
                <td height="22" align="right" width="575"><font face="Arial, Helvetica, sans-serif">Handling</font>:</td>
                <td nowrap width="46"> 
                  <%
			If iConverion = 1 Then
		...
		%>
              <% If bCod Then %>
              <tr> 
                <td height="22" align="right" width="575"><font face="Arial, Helvetica, sans-serif">COD 
                  Charge:</font></td>
                <td nowrap width="46"> 
                  <%
			If iConverion = 1 Then
		...
		If sShipping <> 0 OR iShipMethod = 19 or sFreeShip =True Then 
		         if bltl = false then
		           %>
              <tr> 
                <td height="22" align="right" width="575"><%= sShipMethodName %>:</td>
                <td nowrap width="46"> 
                  <%
	              	If iConverion = 1  Then
...
'		          End if 
		    ...
		    End If %>
              <% If iCTax <> 0 Then %>
              <tr> 
                <td height="22" align="right" width="575"><font face="Arial, Helvetica, sans-serif">Country 
                  Tax:</font></td>
                <td nowrap width="46"> 
                  <%
			If iConverion = 1 Then
			...
			%>
              ...
              <% If iSTax <> 0 Then %>
              <tr> 
                <td height="22" align="right" width="575"><font face="Arial, Helvetica, sans-serif">State 
                  Tax:</font></td>
                <td nowrap width="46"> 
                  <%
			If iConverion = 1 Then
			...
			%>
              ...
              <% End If %>
              <tr> 
                <td height="22" align="right" width="575"><b><font face="Arial, Helvetica, sans-serif">Grand 
                  Total:</font></b></td>
                <td nowrap width="46"><b> 
                  <%
		If iConverion = 1 Then
		...
		%>
              ...
              <tr> 
                <td colspan="2" valign="top" height="32"> 
                  <div align="center"><font color="#6699CC" face="Arial, Helvetica, sans-serif">(NOTE: 
                    The shipping cost shown above is an estimate. The actual cost 
                    is likely to be less and will be lowered at time of processing 
                    if necessary. Credit cards are not charged until orders are 
                    ready to ship.)</font></div>
                </td>
                <td height="32" width="2"></td>
              </tr>
              <% End If %>
            </table>
          </td>
            ...
            <tr>
          <td width="100%" class="tdContent2" height="280"> <HIDE_SF_PRESERVE><form method="post" name="frmVerify" action="confirm.asp" onSubmit="javascript: <%=sSubmitAction %>"></HIDE_SF_PRESERVE> 
            <table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr> 
                <td valign="top" colspan="3" height="20" class="tdContentBar"> 
                  <div align="center"><font face="Arial, Helvetica, sans-serif">Customer 
                    Information</font></div>
                </td>
              </tr>
              <tr> 
                <td height="20" width="313"><b><font face="Arial, Helvetica, sans-serif">Billing:</font></b></td>
                <td width="303"><b><font face="Arial, Helvetica, sans-serif">Ship 
                  To:</font></b></td>
                <td width="7"></td>
              </tr>
              <tr> 
                <td height="22" width="313"><%= sCustFirstName %>&nbsp<%= sCustMiddleInitial %>&nbsp<%= sCustLastName %></td>
                <td width="303"><%= sShipCustFirstName %>&nbsp<%= sShipCustMiddleInitial %>&nbsp<%= sShipCustLastName %></td>
                <td width="7"></td>
              </tr>
              <tr> 
                <td height="22" width="313"><%= sCustCompany %></td>
                <td width="303"><%= sShipCustCompany%></td>
                <td width="7"></td>
              </tr>
              <tr> 
                <td height="22" width="313"><%= sCustAddress1 %></td>
                <td width="303"><%= sShipCustAddress1 %></td>
                <td width="7"></td>
              </tr>
              <%If sCustAddress2 <> "" or sShipCustAddress2 <>"" Then%>
              <tr> 
                <%If sCustAddress2 <> "" Then%>
                <td height="22" width="313"><%= sCustAddress2 %></td>
                <%else%>
                <td valign="top" width="303"><%= sShipCustAddress2%></td>
                <%End If%>
              ...
              <%End If%>
              <tr> 
                <td height="22" width="313"><%= sCustCity%>,&nbsp;<%= sCustStateName %>,&nbsp;<%= sCustZip%></td>
                <td width="303"><%= sShipCustCity%>,&nbsp;<%= sShipCustStateName %>,&nbsp;<%= sShipCustZip %></td>
                <td width="7"></td>
              </tr>
              <tr> 
                <td height="22" width="313"><%= sCustCountryName %></td>
                <td width="303"><%= sShipCustCountryName %></td>
                <td width="7"></td>
              </tr>
              <tr> 
                <td height="0" width="313"></td>
                <td width="303"></td>
                <td width="7"></td>
              </tr>
              <tr> 
                <td height="22" width="313"> 
                  <% If sCustPhone <> "" Then %>
                  <font face="Arial, Helvetica, sans-serif">Phone:</font> <%= sCustPhone%> 
                  <% Else %>
                  &nbsp; 
                  <% End If %>
                </td>
                <td width="303"> 
                  <% If sShipCustPhone <> "" Then %>
                  <font face="Arial, Helvetica, sans-serif">Phone: </font><%= sShipCustPhone %> 
                  <% Else %>
                  &nbsp; 
                  <% End If %>
                </td>
              ...
              <tr> 
                <td height="22" width="313"> 
                  <% If sCustFax <> "" Then %>
                  <font face="Arial, Helvetica, sans-serif">Fax:</font> <%= sCustFax%> 
                  <% Else %>
                  &nbsp; 
                  <% End If %>
                </td>
                <td width="303"> 
                  <% If sShipCustFax <> "" Then %>
                  <font face="Arial, Helvetica, sans-serif">Fax:</font> <%= sShipCustFax %> 
                  <% Else %>
                  &nbsp; 
                  <% End If %>
                </td>
              ...
              <% End If %>
              <tr> 
                <td height="22" width="313"><%= sCustEmail%></td>
                <td width="303"><%= sShipCustEmail %></td>
                <td width="7"></td>
              </tr>
              <%If sShipping <> 0 OR iShipMethod = 19 or sFreeShip =True Then %>
              <tr> 
                <td height="17" width="313"></td>
                <td width="303" height="17"><b><font face="Arial, Helvetica, sans-serif">Ship 
                  Via:</font></b> <%= sShipMethodName %></td>
            ...
            <table class="tdContent2" border="0" width="100%" cellpadding="2" cellspacing="0">
              <tr> 
                <td height="24" colspan="2"> 
                  <table border="0" width="100%" cellpadding="2" cellspacing="0" class="tdContentBar">
                    <tr> 
                      <td width="100%" class="tdContentBar"> 
                        <div align="center"><font face="Arial, Helvetica, sans-serif">Credit 
              ...
              <tr> 
                <td valign="top" height="20" colspan="2">
                  <div align="center"><img src="cards.gif" width="200" height="31"></div>
                </td>
                <td></td>
              </tr>
              <tr> 
                <td height="20" valign="top" width="100%"><b><font face="Arial, Helvetica, sans-serif">Card 
                  Type</font></b><font color="#FF0000" face="Arial, Helvetica, sans-serif">*</font><font face="Arial, Helvetica, sans-serif"><b>:</b></font></td>
                <td valign="top" width="315"><b><font face="Arial, Helvetica, sans-serif">Name 
                  as it appears on card<font color="#FF0000">*</font>:</font></b></td>
                <td></td>
              </tr>
              <tr> 
                <td valign="top" height="32"> 
                  <select name="CardType" title="Credit Card Type" style="<%= C_FORMDESIGN %>">
                    <%= sCCList %> 
                  </select>
                </td>
                <td valign="top"> 
                  <input type="text" name="CardName" title="Name on Card" size="30" Style="<%= C_FORMDESIGN%>">
                </td>
                <td></td>
              </tr>
              <tr> 
                <td valign="top" height="20"><b><font face="Arial, Helvetica, sans-serif">Card 
                  Number<font color="#FF0000">*</font>:</font></b></td>
                <td valign="top"><b><font face="Arial, Helvetica, sans-serif">Expiration 
                  Date<font color="#FF0000">*</font></font></b><font color="#FF0000" face="Arial, Helvetica, sans-serif"> 
                  </font><font face="Arial, Helvetica, sans-serif">(e.g. 03 | 
                  2008):</font></td>
                <td></td>
              </tr>
              <tr> 
                <td height="32" valign="top"> 
                  <input type="text" name="CardNumber" title="Credit Card Number" size="30" style="<%= C_FORMDESIGN%>">
                </td>
                <td valign="top"><font face="Arial, Helvetica, sans-serif">Month 
                  <input type="text" size="2" name="CardExpiryMonth" title="Credit Card Month" onfocusout="return ValidateMe(this)" Style="<%= C_FORMDESIGN%>">
                  Year 
                  <input type="text" size="4" name="CardExpiryYear" title="Credit Card Year" onfocusout="return ValidateMe(this)" Style="<%= C_FORMDESIGN%>">
                  <b><i>(enter full year: &quot;2012&quot;)</i></b></font> </td>
                <td></td>
              </tr>
              <tr> 
                <td height="0"></td>
              ...
              <tr> 
                <td height="2"></td>
                <td height="2"><img height="1" width="315" src="/transparent.gif"></td>
                <td height="2"><img height="1" width="1" src="/transparent.gif"></td>
              </tr>
            </table>
		    ...
		    <tr>
              ...
              <!--Shipping--><!--Special Instructions-->
                <tr><td width="100%" class="tdContent2">   
	                <table border="0" width="100%" cellspacing="0" cellpadding="2">
	                  <tr>
	                    <td width="100%" colspan="2" class="tdContentBar">
                  <div align="center"><font face="Arial, Helvetica, sans-serif">Message/Special 
                    Instructions</font></div>
                </td>
	                  </tr>           
                      <%If sInstructions = "" Then %>
                      <tr>
                <td width="100%" colspan="2" align="center" height="40" valign="center"><i><font face="Arial, Helvetica, sans-serif">None 
                  Specified</font></i></td>
              </tr>
                      <% Else 
                      'security chk
